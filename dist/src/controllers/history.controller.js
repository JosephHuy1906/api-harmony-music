...
class HistoryController {
    ...
    information(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const userId = (res.locals.memberDecoded && res.locals.memberDecoded._id) || '';
            const historyInfoService = yield service_instance_1.historyService.getInformation(userId);
    ...
    mergingCreateUpdate(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const history = yield service_instance_1.historyService.bothCreateUpdate(userId, songId);
...
], HistoryController.prototype, "mergingCreateUpdate", null);
