...
class AlbumController {
    static async create(req, res) {
        ...
        const createAlbumService = await album_service_1.default.create(payload);
        return res.status(createAlbumService.status).json(createAlbumService);
    }
}
exports.default = AlbumController;
__decorate([
    (0, index_decorator_1.IsRequirementReq)(['title', 'publish', 'composerReference'], 'body'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], AlbumController, "create", null);
